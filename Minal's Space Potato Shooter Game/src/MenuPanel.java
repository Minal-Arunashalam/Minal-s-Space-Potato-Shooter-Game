...
public class MenuPanel {
	...
	String projectName = "AcadamiesHacks Project";
	String myName = "Minal Arunashalam";
	String about = "About";
	String help = "Help";
	String exit = "Exit";
	String play = "Play";
	...
	public void draw(Graphics2D g2d) {
		...
		g2d.drawString("Space Potato Shooter", 330, 100);
		g2d.setColor(Color.WHITE);
		g2d.setFont(game.font);
		g2d.drawString("Minal Arunashalam", 360, 135);
